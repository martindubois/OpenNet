...
public:
    ...
    virtual bool Packet_Receive    (OpenNet_BufferInfo * aBuffer, unsigned int aIndex);
    virtual bool Packet_Send       (OpenNet_BufferInfo * aBuffer, unsigned int aIndex);
    virtual bool Packet_Send       (const void * aPacket, unsigned int aSize_byte);
...
private:
    ...
    void Packet_Send(uint64_t aLogical, unsigned int aSize_byte, volatile long * aCounter);
