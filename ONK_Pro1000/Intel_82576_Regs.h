...
Intel_82576_FlowControlReceiveThresholdHigh;
...
Intel_82576_FlowControlReceiveThresholdLow;
...
Intel_82576_FlowControlRefreshThreshold;
...
Intel_82576_GeneralPurposeInterruptEnable;
...
Intel_82576_InterruptVectorAllocation;
...
Intel_82576_InterruptVectorAllocationMisc;
...
Intel_82576_Rx_DescriptorControl;
...
Intel_82576_Rx_DescriptorRingLength;
...
Intel_82576_Rx_DmaMaxOutstandingData;
...
Intel_82576_Rx_LongPacketMaximumLength;
...
Intel_82576_Rx_PacketBufferSize;
...
Intel_82576_Rx_QueueDropPacket;
...
Intel_82576_Rx_SplitAndReplicationControl;
...
Intel_82576_SwitchPacketBufferSize;
...
Intel_82576_Tx_DescriptorControl;
...
Intel_82576_Tx_DescriptorRingLength;
...
Intel_82576_Tx_PacketBufferSize;
...
typedef struct
{
    ...
    Intel_82576_MdiControl mMdiControl; // 0x00020

    REG_RESERVED(00024, 00100);

    Intel_82576_Rx_Control mRx_Control; // 0x00100

    REG_RESERVED(00104, 00400);

    Intel_82576_Tx_Control mTx_Control; // 0x00400

    REG_RESERVED(00404, 00410);

    Intel_82576_Tx_InterPacketGap mTx_InterPacketGap; // 0x00410

    REG_RESERVED(00414, 01500);

    Intel_82576_InterruptMask mInterruptCauseRead; // 0x01500

    REG_RESERVED(01504, 01508);

    Intel_82576_InterruptMask                 mInterruptMaskSet             ; // 0x01508
    Intel_82576_InterruptMask                 mInterruptMaskClear           ; // 0x0150c
    Intel_82576_InterruptMask                 mInterruptAcknowledgeAutoMask ; // 0x01510
    Intel_82576_GeneralPurposeInterruptEnable mGeneralPurposeInterruptEnable; // 0x01514

    REG_RESERVED(01518, 01680);

    Intel_82576_InterruptThrottle mInterruptTrottle[25]; // 0x01680

    REG_RESERVED(016e4, 01700);

    Intel_82576_InterruptVectorAllocation mInterruptVectorAllocation[8]; // 0x01700

    REG_RESERVED(01720, 01740);

    Intel_82576_InterruptVectorAllocationMisc mInterruptVectorAllocationMisc; // 0x01740

    REG_RESERVED(01744, 02160);

    Intel_82576_FlowControlReceiveThresholdLow mFlowControlReceiveThresholdLow; // 0x02160 - page 488

    REG_RESERVED(02164, 02168);

    Intel_82576_FlowControlReceiveThresholdHigh mFlowControlReceiveThresholdHigh; // 0x02168 - page 489

    REG_RESERVED(0216c, 02404);

    Intel_82576_Rx_PacketBufferSize mRx_PacketBufferSize; // 0x02404

    REG_RESERVED(02408, 02460);

    Intel_82576_FlowControlRefreshThreshold mFlowControlRefreshThreshold; // 0x02460

    REG_RESERVED(02464, 02540);

    Intel_82576_Rx_DmaMaxOutstandingData mRx_DmaMaxOutstandingData; // 0x2540 - Page 524

    REG_RESERVED(02544, 03004);

    Intel_82576_SwitchPacketBufferSize mSwitchPacketBufferSize; // 0x03004

    REG_RESERVED(03008, 03404);

    Intel_82576_Tx_PacketBufferSize mTx_PacketBufferSize; // 0x03404

    REG_RESERVED(03408, 03590);

    Intel_82576_Tx_DmaControl mTx_DmaControl;// 0x03590
    ...
    Intel_82576_Rx_LongPacketMaximumLength mRx_LongPacketMaximumLength; // 0x05004

    REG_RESERVED(05008, 05400);

    Intel_82576_Rx_AddressLow  mRx_AddressLow0 ; // 0x05400
    Intel_82576_Rx_AddressHigh mRx_AddressHigh0; // 0x05404

    REG_RESERVED(05408, 0c000);

    uint32_t                                  mRx_DescriptorBaseAddressLow0 ; // 0x0c000
    uint32_t                                  mRx_DescriptorBaseAddressHigh0; // 0x0c004
    Intel_82576_Rx_DescriptorRingLength       mRx_DescriptorRingLength0     ; // 0x0c008
    Intel_82576_Rx_SplitAndReplicationControl mRx_SplitAndReplicationControl; // 0x0c00c
    Intel_82576_Rx_DescriptorHead             mRx_DescriptorHead0           ; // 0x0c010

    REG_RESERVED(0c014, 0c018);

    Intel_82576_Rx_DescriptorTail mRx_DescriptorTail0; // 0xc018

    REG_RESERVED(0c01c, 0c028);

    Intel_82576_Rx_DescriptorControl mRx_DescriptorControl0; // 0x0c028

    REG_RESERVED(0c02c, 0c030);

    Intel_82576_Rx_QueueDropPacket mRx_QueueDropPacket0; // 0x0c030

    REG_RESERVED(0c034, 0e000);

    uint32_t                            mTx_DescriptorBaseAddressLow0 ; // 0x0e000
    uint32_t                            mTx_DescriptorBaseAddressHigh0; // 0x0e004
    Intel_82576_Tx_DescriptorRingLength mTx_DescriptorRingLength0     ; // 0x0e008

    REG_RESERVED(0e00c, 0e010);

    Intel_82576_Tx_DescriptorHead mTx_DescriptorHead0; // 0x0e010

    REG_RESERVED(0e014, 0e018);

    Intel_82576_Tx_DescriptorTail mTx_DescriptorTail0; // 0x0e018

    REG_RESERVED(0e01c, 0e028);

    Intel_82576_Tx_DescriptorControl mTx_DescriptorControl0; // 0x0e028
